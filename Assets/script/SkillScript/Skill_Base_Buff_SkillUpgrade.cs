...
public class Skill_Base_Buff_SkillUpgrade : Skill_Base_Buff_Passive
{
    ...
    {
        //尋找場景上所有技能效果內容
        //var findEffectResult = FindObjectsOfType<Skill_Base>().ToList();
        //if (findEffectResult.Count > 0 && findEffectResult != null)
        //{
        //    var getSkillListOnScene = findEffectResult.Where(x => x.SkillName.Contains(SkillName)).ToList();
        //    getSkillListOnScene.ForEach(x =>
        //    {
        //        x.GetSkillUpgradeEffect(this);
        //    });
        //}
        //尋找場景上所有SkillUI
